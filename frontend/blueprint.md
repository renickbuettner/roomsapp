            ...
            App.addons.RoomManager = {
                ...
                Actions: {
                    ...
                    onFormLeave: function () {
                        ...
                        if(App.cache.lastOpenedRoom == undefined || App.cache._last)
...
+ Request (application/x-www-form-urlencoded; charset=utf-8)
    ...
    + Body
            ...
            email=me%40renickbuettner.de&password=renick
...
+ Request (application/x-www-form-urlencoded; charset=utf-8)
    ...
    + Body
            ...
            password=Sassassasan&name=Frau+Sh%C3%A2rl+en+Rischt%C3%A9r&email=sharly%40normandie.fr&group=0



# GET /users/cmVuaWNrLmJ1ZXR0bmVyQG1lLmNvbQ==
...
# PUT /users/cmVuaWNrLmJ1ZXR0bmVyQG1lLmNvbQ==
...
# DELETE /users/Y2FybWVuLnNjaHdhcnpAY2l0cm9lbi5jbHVi
...
# GET /rooms/1/reservations/1515711600/1515798000
...
+ Request (application/x-www-form-urlencoded; charset=utf-8)
    ...
    + Body
            ...
            begin=1517310000&end=1517314802&notes=Test
...
+ Request (application/x-www-form-urlencoded; charset=utf-8)
    ...
    + Body
            ...
            begin=1&end=2&user=3&room=4&notes=5
